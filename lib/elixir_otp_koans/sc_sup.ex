defmodule ElixirOtpKoans.ScSup do
  ...
  """
  def init([]) do
    element = {ElixirOtpKoans.ScElement, {ElixirOtpKoans.ScElement, :start_link, []},
              :temporary, :brutal_kill, :worker, [ElixirOtpKoans.ScElement]}
    children = [element]
